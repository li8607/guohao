...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget _emailPasswordWidget(
    ...
    return Column(
      children: <Widget>[
        _entryField("账号", controller: username),
        _entryField("密码", isPassword: true, controller: password),
      ],
    );
  }
        ...
        listener: (context, state) {
          if (state is UserLoginInProgress) {
            if (loadingDialog == null) {
              ...
              loadingDialog.update(message: '正在登录...');
            }
            loadingDialog.show();
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    _emailPasswordWidget(username, password),
                    SizedBox(
                      height: 20,
                    ),
                    InkWell(
                        onTap: () {
                          BlocProvider.of<UserBloc>(context).add(UserLogined(
